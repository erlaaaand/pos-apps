...
import 'package:business_management/features/orders/domain/order_detail.dart';
import 'package:business_management/features/production/domain/fifo_selector.dart';
...
void main() {
  test('includes orders oldest-first while stock allows', () {
    final orders = [
      OrderDetail(order: _order(1, 5, DateTime(2026, 1, 1, 8)), productName: 'A'),
      OrderDetail(order: _order(2, 5, DateTime(2026, 1, 1, 9)), productName: 'A'),
      OrderDetail(order: _order(3, 5, DateTime(2026, 1, 1, 10)), productName: 'A'),
    ];
  ...
  test('skips an order that would exceed stock but keeps checking later ones', () {
    final orders = [
      OrderDetail(order: _order(1, 1, DateTime(2026, 1, 1, 8)), productName: 'A'),
      OrderDetail(order: _order(2, 1, DateTime(2026, 1, 1, 9)), productName: 'A'),
      OrderDetail(order: _order(3, 1, DateTime(2026, 1, 1, 10)), productName: 'A'),
    ];
    final need = {
