...
void main() async {
  ...
  if (appSupportDir == null) {
    print('Gagal menemukan direktori aplikasi.');
    return;
  }
  ...
  final initialData = [
    ...
    _SeedItem('Santan', IngredientUnit.milliliter, 'Bahan Dapur', 1000, 12000),
  ...
  await db.close();
  print('Pengisian data 24 bahan baku ke database selesai!');
}
